...
async def cmd_start(m: Message):
    ...
    txt = (
        ...
        f"Важное: ffmpeg доступен: {HAS_FFMPEG}, ffprobe доступен: {HAS_FFPROBE}\n"
        "Если ffmpeg не установлен на хостинге — некоторые видео (DASH) не будут объединяться и аудио извлекаться полностью."
    )
    await m.answer(txt)
